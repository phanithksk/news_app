  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder(
          init: HomeController(),
          initState: (state) {
            controller.getBreakingNewsData();
          },
          builder: (cont) {
            return Obx(() {
              if (controller.breakingNewsData.value.code == 404) {
                return Text('${controller.breakingNewsData.value.message}');
              ...
              return ListView(
                ...
                children: [
                  ...controller.breakingNewsData.value.data.map(
                    (e) => GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
